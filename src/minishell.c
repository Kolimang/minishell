...
/*   Updated: 2024/10/30 19:26:17 by lboumahd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list *mock_command_line(void)
{
 ...
 t_redir *redir_heredoc2 = malloc(sizeof(t_redir));
	...
	// ft_lstadd_back(&(cmd->ls_redirs),ft_lstnew(redir_heredoc2));// < infile1
...
//     // ft_lstadd_back(&(cmd1->ls_redirs), ft_lstnew(heredoc_redir1));
//     // ft_lstadd_back(&(cmd1->ls_redirs), ft_lstnew(redir1));
